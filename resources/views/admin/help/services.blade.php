                                ...
                                <?php $i=1; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          @else
                                              <img src="{{ url('Uploaded/default.png') }}" alt="image" style="margin-right: 10px;" />
                                                    ...
                                                    <div class="row">
                                                      <div class="col-6 form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                                                              <label for="email" class="col-md-4 control-label">Gambar<i style="content:'*';color:'red';" aria-hidden="true"></i></label>
                                                                <div class="col-12">
                                                                    <img width="300" height="250" @if($data->fileImg) src="{{ url('Uploaded/Images/Product',$data->fileImg) }}" @endif />
