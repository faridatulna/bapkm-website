		...
		<!-- Wrapper -->
			<div id="wrapper">
                ...
                <section style="padding-top: 1.25em;">
									<div class="posts">
										<article>
											<a href="/article-single" class="image"><img src="{{ asset('Editorial/images/pic01.jpg') }}" alt="" /></a>
											<h3>Interdum aenean</h3>
											<p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore. Proin aliquam facilisis ante interdum. Sed nulla amet lorem feugiat tempus aliquam.</p>
											<ul class="actions">
												<li><a href="/article-single" class="button">More</a></li>
											</ul>
										</article>
										<article>
											<a href="/article-single" class="image"><img src="{{ asset('Editorial/images/pic02.jpg') }}" alt="" /></a>
										...
										<article>
											<a href="/article-single" class="image"><img src="{{ asset('Editorial/images/pic03.jpg') }}" alt="" /></a>
										...
										<article>
											<a href="/article-single" class="image"><img src="{{ asset('Editorial/images/pic04.jpg') }}" alt="" /></a>
										...
										<article>
											<a href="/article-single" class="image"><img src="{{ asset('Editorial/images/pic05.jpg') }}" alt="" /></a>
										...
										<article>
											<a href="/article-single" class="image"><img src="{{ asset('Editorial/images/pic06.jpg') }}" alt="" /></a>
